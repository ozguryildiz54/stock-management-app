...
[![Deploy Backend with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fyldzozgur%2Fstock-management-app&env=MONGODB,SECRET_KEY,ACCESS_KEY,REFRESH_KEY,NODE_ENV&envDescription=Atlas%20connection%20string%20%2B%20three%20random%20JWT%20secrets&project-name=stock-api&repository-name=stock-api)

[![Deploy Frontend with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fyldzozgur%2Fstock-management-app&root-directory=client&env=VITE_BASE_URL&envDescription=Backend%20URL%20from%20step%201&project-name=stock-client&repository-name=stock-client)
...
```bash
pnpm install
cp .env.example .env   # add MONGODB, SECRET_KEY, ACCESS_KEY, REFRESH_KEY, PAGE_SIZE
pnpm dev
```
...
API docs available at `http://localhost:8000/api/documents/swagger`.

## 📫 Contact

- **GitHub:** [@yldzozgur](https://github.com/yldzozgur)
- **LinkedIn:** [linkedin.com/in/yldzozgur](https://www.linkedin.com/in/yldzozgur)
